...
| `retrain/backends/local/train.py` | Orchestrates local training, engine setup, and weight sync |
| `retrain/backends/local/lora.py` | Builds and applies local-backend LoRA setup |
